...
SELECT *
FROM `student`
WHERE email LIKE '%.fr%' OR created_at <= '2021-01-10';
...
SELECT *
FROM `project`
WHERE description NOT LIKE '%Dolores%' OR start_date >= '2021-07-01';
...
SELECT * FROM `project`
WHERE start_date >= '2021-01-01' AND start_date <= '2021-07-01';
...
SELECT *
FROM `student`
WHERE (created_at <= '2021-01-10' AND email LIKE '%.fr%')
OR project_id >= 1;
